module gate_top (
  ...
  wire RDY_set_wel_u, RDY_set_swwel_u;
  ...
  testcsrreg_reg0_field0 u (
      ...
      .set_ext_top_wel_sig_v(hwWrite_wel),
      .EN_set_ext_top_wel_sig(1'b1),
      .RDY_set_ext_top_wel_sig(RDY_set_wel_u),
      .set_ext_top_swwel_sig_v(swWrite_swwel),
      .EN_set_ext_top_swwel_sig(1'b1),
      .RDY_set_ext_top_swwel_sig(RDY_set_swwel_u)
  );
  assign RDY_rd = 1'b1;
endmodule
