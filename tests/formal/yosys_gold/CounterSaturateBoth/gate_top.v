// Thin harness wrapper: same common port list as gold_top. hw_incr_count
// /hw_decr_count take the explicit amounts. EN_hw_clear tied to 0;
// bus.read unexercised; currentValue used for rd; hw__read redundant.
module gate_top (
    CLK,
    RST_N,
    incr_amt,
